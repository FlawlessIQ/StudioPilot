 ...
 *
 * Pure and deterministic. The source of truth is features/projects/purge-policy.ts;
 * this is the duplicate `functions/` needs because it has no `@/features` path,
 * and tests/project-purge.test.ts keeps the two identical below these headers.
 */
