 ...
 *
 * The functions copy. features/packages/coverage.ts is the source of truth;
 * functions/ is a separate package with no "@/features" path, so the module is
 * duplicated and tests/package-coverage.test.ts asserts the two files stay
