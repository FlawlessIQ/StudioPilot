...
const responseSchema = z.object({
  ...
  flow: z
    .object({
       ...
       *
       * Never an identifier. The model has no roster tool, so any id it
       * produced would be invention — and optional and `.catch(null)` like
       * everything else here, because a strict field in this object once
       * rejected whole answers.
       */
