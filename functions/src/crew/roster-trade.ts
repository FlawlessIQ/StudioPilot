/**
 * Mirror of features/crew/roster-trade.ts — functions/ is a separate package
 * with no "@/features" path. Compared below the header by tests/crew-roster-trade.test.ts.
 */
