/**
 * Prepared answers — mirror.
 *
 * `features/messaging/prepared-answers.ts` is the source of truth and carries
 * the unit tests (`npm test`); functions/ is a separate package and cannot
 * import from features/. Change the features/ copy first, then bring this in
 * line — the same convention as agreed-retainer.ts and invoice-standing.ts.
 */
