 ...
 *
 * The functions copy. features/questionnaires/starter-templates.ts is the
 * source of truth; functions/ is a separate package with no "@/features" path.
 * `tests/starter-questionnaires.test.ts` compares the two and fails on drift.
 */
