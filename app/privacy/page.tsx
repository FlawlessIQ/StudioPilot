  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <p className="legal-lead">StudioCue is designed around tenant isolation, minimum necessary access, and explicit operational evidence.</p>
        <h2>Data we process</h2>
        <p>Studios provide account, client, project, vendor, crew, document, schedule, and integration data needed to operate their photography business. StudioCue does not store client card or bank credentials.</p>
