  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <h2>Service</h2>
        <p>StudioHub provides photography operations software, workflow coordination, secure portals, integrations, and assistive AI features. It does not provide legal, accounting, insurance, or child-safety advice.</p>
