...
export function CrewPortalShell({ children, active = "Home" }: { children: React.ReactNode; active?: string }) {
  return <AuthBoundary area="crew"><div className="crew-portal-frame">
    ...
    <main className="crew-portal-content"><header><a className="mobile-menu" href="#crew-navigation" aria-label="Open crew navigation"><Menu size={20}/></a><span>Alder &amp; Muse crew workspace</span><SignOutButton/></header>{children}</main>
  </div></AuthBoundary>;
}
