...
export function BillingAction({plan,cadence,label}:{plan?:"studio"|"multi_brand";cadence?:"monthly"|"yearly";label:string}){
  const interactive=useHydrated();const[notice,setNotice]=useState<string|null>(null);
